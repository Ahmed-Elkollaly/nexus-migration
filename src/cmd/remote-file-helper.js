...
export async function uploadFile({method, url, username, password, format, filePath, fileReadStream}) {
    return new Promise((resolve, reject) => {
        ...
        fd.append(`${format}.groupId`, 'org.maven.com');
        fd.append(`${format}.artifactId`, 'junit');
        fd.append(`${format}.version`, '1.3');
        fd.append(`${format}.asset.extension`,'jar')
        console.log("Form Data Headers : ",fd.getHeaders())
